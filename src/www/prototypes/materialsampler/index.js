...
function initMaterialSamples(prototype) {
	...
	var dMM = new DynamicMaterialManager(prototype.renderer);
	...
	var normalMaterial = createNormalMaterial(loadShader, noiseMap);
	var forceFieldMaterial = createForceFieldMaterial(loadShader, noiseMap);
	...
	prototype.onupdate = dMM.update;
	prototype.onrender = dMM.render;
